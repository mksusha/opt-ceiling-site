...
export default function Home() {
    return (
        <div className="bg-midGray text-black py-20 px-6 md:px-8">
            <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-10 md:gap-16 min-h-[600px]">
                ...
                <div className="relative w-64 h-64 md:w-96 md:h-96 flex-shrink-0">
                    <div className="relative w-64 h-64 md:w-96 md:h-96 flex-shrink-0 flame-mask">
                        <Image
                            src="/nevsky1.jpg"
                ...
                <div className="flex-1 max-w-xl text-center md:text-left">
                    <h2 className="text-3xl text-white md:text-5xl font-bold uppercase leading-tight">
                        МЫ СОЗДАЕМ НЕ ПРОСТО ВЫСТАВКУ — <span className="text-[#FF551A]">МЫ СОЗДАЕМ ДРАЙВ</span>
                    </h2>
                    <p className="text-base md:text-lg text-white mt-4 md:mt-6">
