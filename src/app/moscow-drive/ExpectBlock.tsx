...
export default function ExpectBlock() {
    ...
    return (
        <div className="w-full max-w-[1350px] mx-auto px-5 pt-10 sm:pt-20 bg-white">
            {/* Заголовок */}
            <h2
                className="font-semibold text-darkGray text-[32px] lg:text-[55px] sm:text-4xl mb-8 sm:mb-24 mt-6 sm:mt-12 uppercase text-center sm:px-0"
            ...
            >
                {items.map((item, index) => (
                    <div
                        key={index}
                        className="flex mb-10 flex-col items-center sm:items-start text-center sm:text-left"
                    >
                        {/* Квадрат с SVG */}
                        <div
