    ...
    return (
        <div className="px-4 sm:px-8 lg:px-16 py-12 bg-gradient-to-b from-gray-50 to-gray-100 relative text-center">
            ...
            <div className="flex justify-center items-center mb-14">
                <div
                    className="w-full max-w-[1350px] p-8 bg-midGray rounded-3xl shadow-2xl border border-gray-200 relative">
                    <div
                    ...
                    >
                        <span className="text-white">Регистрируйся</span> на <span
                        className="text-orange">мероприятие</span>
                        <br/> и <span className="text-white">приводи</span> <span className="text-orange">друзей</span>
                    </h2>
            ...
            {/* Дополнительный текст под карточкой */}
            {/*<p className="text-sm text-midGray">*/}
            {/*    Для участников из других городов скидка на проживание 10%. По вопросам бронирования*/}
            {/*    обращайтесь к организатору +79807155232 (WhatsApp/Telegram).*/}
            {/*</p>*/}
        </div>
    );
};
